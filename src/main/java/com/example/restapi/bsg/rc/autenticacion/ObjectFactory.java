 ...
 * generated in the com.becas.exceluploader.bsg.rc;.autenticacion package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.becas.exceluploader.bsg.rc;.autenticacion
     *
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ValidarPermiso }{@code >}}
     *
     */
    @XmlElementDecl(namespace = "http://bsg.gob.ec/AccesoBSGService", name = "ValidarPermiso")
    public JAXBElement<ValidarPermiso> createValidarPermiso(ValidarPermiso value) {
        return new JAXBElement<ValidarPermiso>(_ValidarPermiso_QNAME, ValidarPermiso.class, null, value);
    }
    ...
    public JAXBElement<ValidarPermisoResponse> createValidarPermisoResponse(ValidarPermisoResponse value) {
        return new JAXBElement<ValidarPermisoResponse>(_ValidarPermisoResponse_QNAME, ValidarPermisoResponse.class, null, value);
    }
